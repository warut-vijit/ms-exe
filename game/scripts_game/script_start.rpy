...
##define characters
  ...
  image isolda U_P1_E4 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P1_E4.png", 0.65)
  image isolda U_P1_E5 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P1_E5.png", 0.65)
  image isolda U_P1_E6 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P1_E6.png", 0.65)
  image isolda U_P1_E7 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P1_E7.png", 0.65)
  image isolda U_P1_E8 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P1_E8.png", 0.65)
  image isolda U_P2_E1 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P2_E1.png", 0.65)
  image isolda U_P2_E2 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P2_E2.png", 0.65)
  image isolda U_P2_E6 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P2_E6.png", 0.65)
  image isolda U_P2_E7 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P2_E7.png", 0.65)
  image isolda U_P2_E8 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P2_E8.png", 0.65)
  image isolda U_P3_E1 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P3_E1.png", 0.65)
  image isolda U_P3_E2 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P3_E2.png", 0.65)
  image isolda U_P3_E3 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P3_E3.png", 0.65)
  image isolda U_P3_E4 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P3_E4.png", 0.65)
  image isolda U_P3_E5 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P3_E5.png", 0.65)
  image isolda U_P3_E6 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P3_E6.png", 0.65)
  image isolda U_P3_E7 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P3_E7.png", 0.65)
  image isolda U_P3_E8 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P3_E8.png", 0.65)
  ...
  image isolda U_P5_E6 = im.FactorScale("images/Sprites/Main Characters/Isolda/Uniform/Isolda_Uniform_P5_E6.png", 0.65)
...
##  image hilda P1_E3 = im.FactorScale("images/Sprites/Side Characters/Brunhilde/Brunhilde_P1_E3.png", 0.75)
  ...
  image dad P1_E1 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P1_E1.png", 0.70)
  image dad P1_E2 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P1_E2.png", 0.70)
  image dad P1_E4 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P1_E4.png", 0.70)
  image dad P1_E5 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P1_E5.png", 0.70)
  image dad P1_E7 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P1_E7.png", 0.70)
  image dad P1_E9 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P1_E9.png", 0.70)
  image dad P2_E1 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P2_E1.png", 0.70)
  image dad P2_E2 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P2_E2.png", 0.70)
  image dad P2_E4 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P2_E4.png", 0.70)
  image dad P2_E5 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P2_E5.png", 0.70)
  image dad P2_E7 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P2_E7.png", 0.70)
  image dad P2_E9 = im.FactorScale("images/Sprites/Side Characters/Mr Wilhelm/MrWilhelm_P2_E9.png", 0.70)
